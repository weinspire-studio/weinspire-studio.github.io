...
},{"dom7/dist/dom7.modular":4,"ssr-window":5}],3:[function(require,module,exports){
...
},{"ssr-window":5}],5:[function(require,module,exports){
"use strict";
...
function largeScreenCode() {
  ...
  restoreDesktopNav();
  styleAnchorOnHover();
  animateImages(); // if (swiper && swiper.params.init === true) {
  //   swiper.destroy();
  // }
...
function smallScreenCode() {
  ...
  var asd = (0, _swiper.defineSwiper)();
...
},{"./swiper":7}],7:[function(require,module,exports){
"use strict";
...
},{"../node_custom_modules/swiper/css/swiper.min.css":1,"../node_custom_modules/swiper/js/swiper.esm.js":2}]},{},[6,7]);
