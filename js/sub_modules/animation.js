...
function prepareRequests() {
  ...
  makeRequest(baseUrl + targets[0], sectionBg, debouncedTest);
  makeRequest(baseUrl + targets[1], designContainer, debouncedTest2);
  makeRequest(baseUrl + targets[2], softwareContainer, animateIconSoftware);
  makeRequest(baseUrl + targets[3], marketingContainer, animateIconMarketing);
}
