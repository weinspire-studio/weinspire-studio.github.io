...
})()(
  {
    12: [
      function (require, module, exports) {
        ...
        exports.mobileDeferCode = mobileDeferCode;
        exports.slideRightArrows = slideRightArrows;

        var _swiper = require("../sub_modules/swiper");

        // jshint esversion: 6
        var designProjectsSection = document.getElementById("section-projects-design"); //prettier-ignore

        var rightArrowsContainer = document.querySelector(
        ...
        function mobileDeferCode(isSafari, supportsPassive, debounce) {
          ...
          var swiper = (0, _swiper.defineSwiper)();
        ...
        function showRightArrows(supportsPassive) {
          ...
          var threshold = designOffset - clientHeight + 300;
      ...
      { "../sub_modules/swiper": "/js/sub_modules/swiper.js" },
    ],
    2: [
      function (require, module, exports) {
        var css =
        ...
        require("browserify-css").createStyle(
          css,
          { href: "node_custom_modules/swiper/css/swiper.min.css" },
          { insertAt: "bottom" }
        );
        module.exports = css;
      },
    ...
    3: [
      function (require, module, exports) {
        ...
        var Utils = {
          ...
          getTranslate: function getTranslate(el) {
            ...
            if (_ssrWindow.window.WebKitCSSMatrix) {
              ...
              transformMatrix = new _ssrWindow.window.WebKitCSSMatrix(
        ...
        var Support = (function Support() {
          return {
            touch:
              (_ssrWindow.window.Modernizr &&
                _ssrWindow.window.Modernizr.touch === true) ||
              (function checkTouch() {
                return !!(
                  _ssrWindow.window.navigator.maxTouchPoints > 0 ||
                  "ontouchstart" in _ssrWindow.window ||
                  (_ssrWindow.window.DocumentTouch &&
                    _ssrWindow.document instanceof
                      _ssrWindow.window.DocumentTouch)
                );
              })(),
            pointerEvents:
              !!_ssrWindow.window.PointerEvent &&
              "maxTouchPoints" in _ssrWindow.window.navigator &&
              _ssrWindow.window.navigator.maxTouchPoints > 0,
            observer: (function checkObserver() {
              return (
                "MutationObserver" in _ssrWindow.window ||
                "WebkitMutationObserver" in _ssrWindow.window
              );
            })(),
            passiveListener: (function checkPassiveListener() {
              ...
              try {
                ...
                _ssrWindow.window.addEventListener(
                  "testPassiveListener",
                  null,
                  opts
                );
        ...
        function updateSlides() {
          ...
          for (var i = 0; i < slidesLength; i += 1) {
            ...
            if (params.slidesPerView === "auto") {
              var slideStyles = _ssrWindow.window.getComputedStyle(
                _slide[0],
                null
              );
        ...
        function updateAutoHeight(speed) {
          ...
          if (
            ...
            if (swiper.params.centeredSlides)
              activeSlides.push.apply(
                activeSlides,
                _toConsumableArray(swiper.visibleSlides)
              );
            else {
        ...
        function updateClickedSlide(e) {
          var swiper = this;
          var params = swiper.params;
          var slide = (0, _dom.$)(e.target).closest(
            ".".concat(params.slideClass)
          )[0];
          ...
          if (slide && slideFound) {
            ...
            if (swiper.virtual && swiper.params.virtual.enabled) {
              swiper.clickedIndex = parseInt(
                (0, _dom.$)(slide).attr("data-swiper-slide-index"),
                10
              );
            } else {
        ...
        function slideToClickedSlide() {
          ...
          if (params.loop) {
            ...
            realIndex = parseInt(
              (0, _dom.$)(swiper.clickedSlide).attr("data-swiper-slide-index"),
              10
            );
        ...
        function loopCreate() {
          ...
          if (params.loopFillGroupWithBlank) {
            ...
            if (blankSlidesNum !== params.slidesPerGroup) {
              for (var i = 0; i < blankSlidesNum; i += 1) {
                var blankNode = (0, _dom.$)(
                  _ssrWindow.document.createElement("div")
                ).addClass(
                  ""
                    .concat(params.slideClass, " ")
          ...
          for (var _i3 = 0; _i3 < appendSlides.length; _i3 += 1) {
            $wrapperEl.append(
              (0, _dom.$)(appendSlides[_i3].cloneNode(true)).addClass(
                params.slideDuplicateClass
              )
            );
          }
          ...
          for (var _i4 = prependSlides.length - 1; _i4 >= 0; _i4 -= 1) {
            $wrapperEl.prepend(
              (0, _dom.$)(prependSlides[_i4].cloneNode(true)).addClass(
                params.slideDuplicateClass
              )
            );
          }
        ...
        var Device = (function Device() {
          ...
          var device = {
            ...
            windows: false,
            cordova: !!(
              _ssrWindow.window.cordova || _ssrWindow.window.phonegap
            ),
            phonegap: !!(
              _ssrWindow.window.cordova || _ssrWindow.window.phonegap
            ),
          ...
          device.webView =
            !!(
              ...
              (ua.match(/.*AppleWebKit(?!.*Safari)/i) ||
                _ssrWindow.window.navigator.standalone)
            ) ||
            (_ssrWindow.window.matchMedia &&
              _ssrWindow.window.matchMedia("(display-mode: standalone)")
                .matches);
        ...
        function onTouchStart(event) {
          ...
          if (e.type !== "touchstart") {
            ...
            if (
              ...
              (0, _dom.$)(_ssrWindow.document.activeElement).is(
                data.formElements
              ) &&
        ...
        function onTouchMove(event) {
          ...
          if (data.isTouchEvent && _ssrWindow.document.activeElement) {
            if (
              e.target === _ssrWindow.document.activeElement &&
              (0, _dom.$)(e.target).is(data.formElements)
            ) {
              data.isMoved = true;
              swiper.allowClick = false;
              return;
        ...
        function attachEvents() {
          ...
          if (!Support.touch && Support.pointerEvents) {
            ...
            _ssrWindow.document.addEventListener(
              touchEvents.move,
              swiper.onTouchMove,
              capture
            );
        ...
        function detachEvents() {
          ...
          if (!Support.touch && Support.pointerEvents) {
            ...
            _ssrWindow.document.removeEventListener(
              touchEvents.move,
              swiper.onTouchMove,
              capture
            );
        ...
        var Browser = (function Browser() {
          ...
          return {
            ...
            isUiWebView: /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(
              _ssrWindow.window.navigator.userAgent
            ),
          };
        })();
        ...
        var Resize = {
          ...
          on: {
            ...
            destroy: function destroy() {
              ...
              _ssrWindow.window.removeEventListener(
                "resize",
                swiper.resize.resizeHandler
              );
        ...
        var Observer = {
          func:
            _ssrWindow.window.MutationObserver ||
            _ssrWindow.window.WebkitMutationObserver,
              ...
              if (isHorizontal) {
                ...
                $cubeShadowEl.transform(
                  "scale3d("
                    ...
                    .concat(swiperHeight / 2 + _offset, "px, ")
                ...
                if (params.dynamicBullets) {
                  ...
                  if (swiper.params.loop) {
                    if (
                      ...
                      for (
                        var _i9 = params.dynamicMainBullets;
                        _i9 >= 0;
                        _i9 -= 1
                      ) {
                        bullets
                          .eq(bullets.length - _i9)
                          .addClass(
                            "".concat(params.bulletActiveClass, "-main")
                          );
                      }
            ...
            if (params.clickable) {
              $el.on(
                ...
                function onClick(e) {
                  e.preventDefault();
                  var index =
                    (0, _dom.$)(this).index() * swiper.params.slidesPerGroup;
      ...
      { "dom7/dist/dom7.modular": 5, "ssr-window": 6 },
    ],
    4: [
      function (require, module, exports) {
    ...
    5: [
      function (require, module, exports) {
            ...
            if (typeof selector === "string") {
              ...
              if (_html.indexOf("<") >= 0 && _html.indexOf(">") >= 0) {
                ...
                if (
                  ...
                  // Pure ID selector
                  els = [
                    _ssrWindow.document.getElementById(
                      selector.trim().split("#")[1]
                    ),
                  ];
                } else {
                  // Other selectors
                  els = (context || _ssrWindow.document).querySelectorAll(
                    selector.trim()
                  );
                }
              ...
              selector.nodeType ||
              selector === _ssrWindow.window ||
              selector === _ssrWindow.document
            ) {
              // Node/element
              arr.push(selector);
        ...
        function requestAnimationFrame(callback) {
          if (_ssrWindow.window.requestAnimationFrame)
            return _ssrWindow.window.requestAnimationFrame(callback);
          else if (_ssrWindow.window.webkitRequestAnimationFrame)
            return _ssrWindow.window.webkitRequestAnimationFrame(callback);
          return _ssrWindow.window.setTimeout(callback, 1000 / 60);
        }

        function cancelAnimationFrame(id) {
          if (_ssrWindow.window.cancelAnimationFrame)
            return _ssrWindow.window.cancelAnimationFrame(id);
          else if (_ssrWindow.window.webkitCancelAnimationFrame)
            return _ssrWindow.window.webkitCancelAnimationFrame(id);
        ...
        function offset() {
          if (this.length > 0) {
            ...
            var _scrollTop =
              el === _ssrWindow.window
                ? _ssrWindow.window.scrollY
                : el.scrollTop;

            var _scrollLeft =
              el === _ssrWindow.window
                ? _ssrWindow.window.scrollX
                : el.scrollLeft;
        ...
        function is(selector) {
          ...
          if (typeof selector === "string") {
            ...
            return false;
          } else if (selector === _ssrWindow.document)
            return el === _ssrWindow.document;
          else if (selector === _ssrWindow.window)
            ...
            animate: function animate(props, params) {
              ...
              a.elements.each(function (index, el) {
                ...
                Object.keys(props).forEach(function (prop) {
                  initialFullValue = _ssrWindow.window
                    .getComputedStyle(el, null)
    ...
    "/js/sub_modules/swiper.js": [
      ...
      {
        "../../node_custom_modules/swiper/css/swiper.min.css": 2,
        "../../node_custom_modules/swiper/js/swiper.esm.js": 3,
      },
    ],
  },
  {},
  [12, "/js/sub_modules/swiper.js"]
);
